  ...
  return (
    <aside className="hidden md:flex flex-col w-56 min-h-screen bg-gray-900 text-white">
      <div className="px-6 py-5 border-b border-gray-700">
        <p className="font-bold text-emerald-400 text-lg">HomeConnect SG</p>
      ...
      <div className="px-3 py-4 border-t border-gray-700">
        <button
          ...
          className="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium text-gray-300 hover:bg-gray-800 hover:text-white w-full transition"
        >
